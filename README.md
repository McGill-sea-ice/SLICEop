...
This repository performs the forecast and creates the data and figures to reproduce this website: [__https://web.meteo.mcgill.ca/tremblay/sliceop__](https://web.meteo.mcgill.ca/tremblay/sliceop)
