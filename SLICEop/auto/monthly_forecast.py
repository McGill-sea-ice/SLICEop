...
input_forecast = xr.open_dataset(local_path + "prepro/input_forecast.nc")
...
if os.path.isfile(local_path + "/auto/" + year + "FUDmonthly"):
    with open(local_path + "/auto/" + year + "FUDmonthly", "a") as f:
...
with open(local_path + "/auto/forecastm", "w") as f:
    f.write(str("True"))
f.close()
