...
On the 7th of each month, this script will be run to forecast the freeze-up
date based on the data in 'input_forecast.nc'. Whether the data in
'input_forecast.nc' is based on SEAS5.1 or ERA5 or a combination, is
determined in 'monthly_preprocess.py'. The forecast will forecast a dayofyear,
...
with open(path + "/auto/forecastm", "w") as f:
    f.write(str("True"))
f.close()
